...
<div style="background-color : #f4f4f0" class=" sm:mx-32 lg:mx-32 xl:mx-72">
	<div class="flex justify-between container mx-auto">
		<div class="w-full">
			<div class="mt-4 px-4">
				<h1 class="font-thinner flex text-4xl pt-2 pb-4 px-5">Setup Your Profile</h1>
				...
				<form class="mx-5 my-5">
					...
					<label class="relative mt-5 block p-3 border-2 border-black rounded">
						<span class="text-md font-semibold text-zinc-900"> Gmail </span>
						<input
							class="w-full bg-transparent p-0 text-sm text-gray-500 focus:outline-none"
							id="name"
							type="text"
					...
					<label class="relative block p-3 border-2 mt-5 border-black rounded">
						<span class="text-md font-semibold text-zinc-900"> Upi Id </span>
						...
						/>
						<button class="font-medium bg-blue-500 px-2 text-white text-sm rounded-md"
							>learn more</button
						>
					</label>

					<label class="relative block p-3 border-2 mt-5 border-black rounded">
						<span class="text-md font-semibold text-zinc-900"> Paypal Me </span>
					...
					<p class="text-black text-sm font-normal flex gap gap-2 pt-2">
						<button class="border-2 border-black rounded-md border-b-4 border-l-4 font-black px-2"
							>Business</button
						>
						<button class="border-2 border-black rounded-md border-b-4 border-l-4 font-black px-2"
							>Creative</button
