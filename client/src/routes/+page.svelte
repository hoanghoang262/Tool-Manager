<script>
	import Narbar from '../Component/narbar.svelte';
...
<section>
		...
		>
			<div class="container mx-auto text-left text-white">
				<div class="flex items-center">
					<div class="w-1/2">
						<h1 class="text-5xl font-medium mb-6">Vươn tới tương lai</h1>
						<p class="text-xl mb-12">
							Học tập được ví như hạt giống của kiến thức, còn kiến thức được ví như hạt giống của
							hạnh phúc.
						</p>
						<a href="#" class="bg-indigo-500 text-white py-4 px-12 rounded-full hover:bg-indigo-600"
							>Start</a
						>
					</div>
	...
	<!--Section info-->
	<div class="container mx-auto bg-gray-300 py-10 mb-16">
